...
const STRINGS = {
  fr: {
    ...
    // Héros du Vaisseau Rouge (choix en début de partie + encyclopédie)
    hero_choix_titre:'CHOISIS TON HÉROS',
    hero_choix_hint:'Il pilotera le Vaisseau Rouge pour cette partie.',
    hero_aleatoire:'ALÉATOIRE',
    hero_darkor_nom:'Darkor', hero_darkor_desc:'Casqué tout noir, reflets brillants.', hero_darkor_bonus:'+1 dégât de tir, en permanence',
    hero_odysseus_nom:'Odysseus', hero_odysseus_desc:'Barbu, yeux clairs, peau claire.', hero_odysseus_bonus:"Évite automatiquement une attaque qui l'aurait détruit, une fois par combat",
    hero_acheen_nom:"L'Achéen", hero_acheen_desc:"Cheveux blonds bouclés, peau claire, boucle d'oreille dorée.", hero_acheen_bonus:'Immunisé au premier tir subi à chaque combat, mais +1 dégât reçu sur tous les tirs suivants ce combat-là',
    hero_polypheme_nom:'Polyphème', hero_polypheme_desc:'Cyclope, force brute.', hero_polypheme_bonus:'+50% dégâts de tir, -1 PV max',
    hero_slum_nom:'Slum', hero_slum_desc:'Peau verte gluante, deux yeux globuleux.', hero_slum_bonus:'+2% PV régénérés par tour, en permanence',
    hero_bar4bar4_nom:'Bar4-bar4', hero_bar4bar4_desc:'Femme brune, peau mate.', hero_bar4bar4_bonus:'Les ailes ennemies adjacentes à elle ont une précision réduite',
    hero_demonokos_nom:'Demonokos', hero_demonokos_desc:'Aigle aveugle.', hero_demonokos_bonus:'+1 portée de tir, immunisé aux effets de brouillage (brouilleur/void)',
    hero_androide_nom:'Androïde standard', hero_androide_desc:'Aucun visage distinctif, aucun bonus passif.',
    ...
    ship_normal_nom:'Standard', ship_normal_desc:'Vaisseau de base',
    ship_rapide_nom:'Intercepteur', ship_rapide_desc:'+1 déplacement',
    ship_bombardier_nom:'Bombardier', ship_bombardier_desc:'Détruit la colonne',
    ship_bouclier_nom:'Cuirassé', ship_bouclier_desc:'3 PV',
    ship_sniper_nom:'Tireur', ship_sniper_desc:'Tir à ±2 colonnes',
    ship_transporteur_nom:'Transporteur', ship_transporteur_desc:'Largue des mini-navettes',
    ship_medic_nom:'Médic', ship_medic_desc:'Soigne un allié adjacent',
    ship_rouge_nom:'Vaisseau Rouge', ship_rouge_desc:'Tir de zone · 2 PV',
    ...
    meta_heros_titre:'Arbre des héros',
    meta_heros_hint:"Renforce durablement le bonus passif d'un héros débloqué.",
    ...
    node_heros_nom:'Signal de détresse (héros)', node_heros_desc:'Secours un héros à la dérive',
    ...
    scene_heros_titre:'SIGNAL DE DÉTRESSE',
    ...
    heros_secourir_nom:'Secourir', heros_secourir_desc:'-10% PV · débloque un héros',
    heros_ignorer_nom:'Ignorer', heros_ignorer_desc:'+10% PV',
    heros_rien_nom:'Rien à signaler', heros_rien_desc:'+8 score',
    evt_heros_secouru:'★ Héros secouru : {nom} rejoint la flotte !',
  ...
  en: {
    ...
    guide_fermer:'Close',
    guide_rarete:'Rarity',
    guide_hero_bonus:'Passive bonus',
    ...
    // Heroes of the Red Ship (start-of-run choice + encyclopedia)
    hero_choix_titre:'CHOOSE YOUR HERO',
    hero_choix_hint:'They will pilot the Red Ship for this run.',
    hero_aleatoire:'RANDOM',
    hero_darkor_nom:'Darkor', hero_darkor_desc:'Fully black helmet, glossy highlights.', hero_darkor_bonus:'+1 fire damage, permanently',
    hero_odysseus_nom:'Odysseus', hero_odysseus_desc:'Bearded, light eyes, light skin.', hero_odysseus_bonus:'Automatically survives an attack that would have destroyed it, once per battle',
    hero_acheen_nom:'The Achaean', hero_acheen_desc:'Curly blond hair, light skin, golden earring.', hero_acheen_bonus:'Immune to the first hit each battle, but takes +1 damage on every hit after that',
    hero_polypheme_nom:'Polyphemus', hero_polypheme_desc:'Cyclops, brute force.', hero_polypheme_bonus:'+50% fire damage, -1 max HP',
    hero_slum_nom:'Slum', hero_slum_desc:'Slimy green skin, two bulging eyes.', hero_slum_bonus:'+2% HP regenerated per turn, permanently',
    hero_bar4bar4_nom:'Bar4-bar4', hero_bar4bar4_desc:'Dark-haired woman, tan skin.', hero_bar4bar4_bonus:'Enemy wings adjacent to her have reduced accuracy',
    hero_demonokos_nom:'Demonokos', hero_demonokos_desc:'Blind eagle.', hero_demonokos_bonus:'+1 firing range, immune to jamming effects (jammer/void)',
    hero_androide_nom:'Standard android', hero_androide_desc:'No distinctive face, no passive bonus.',
    ...
    ship_normal_nom:'Standard', ship_normal_desc:'Basic ship',
    ship_rapide_nom:'Interceptor', ship_rapide_desc:'+1 move',
    ship_bombardier_nom:'Bomber', ship_bombardier_desc:'Destroys the column',
    ship_bouclier_nom:'Battleship', ship_bouclier_desc:'3 HP',
    ship_sniper_nom:'Sniper', ship_sniper_desc:'Fires at ±2 columns',
    ship_transporteur_nom:'Carrier', ship_transporteur_desc:'Launches mini-shuttles',
    ship_medic_nom:'Medic', ship_medic_desc:'Heals an adjacent ally',
    ship_rouge_nom:'Red Ship', ship_rouge_desc:'Area fire · 2 HP',
    ...
    meta_heros_titre:'Hero tree',
    meta_heros_hint:"Permanently strengthens an unlocked hero's passive bonus.",
    ...
    node_heros_nom:'Distress signal (hero)', node_heros_desc:'Rescue a drifting hero',
    ...
    scene_heros_titre:'DISTRESS SIGNAL',
    ...
    heros_secourir_nom:'Rescue', heros_secourir_desc:'-10% HP · unlocks a hero',
    heros_ignorer_nom:'Ignore', heros_ignorer_desc:'+10% HP',
    heros_rien_nom:'Nothing to report', heros_rien_desc:'+8 score',
    evt_heros_secouru:'★ Hero rescued: {nom} joins the fleet!',
